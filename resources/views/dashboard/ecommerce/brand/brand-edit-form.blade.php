            ...
            <form class="needs-validation" method="POST" action="{{ route('brand.update', $brandEdit->id) }}" enctype="multipart/form-data" novalidate>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <span class="input-group-text"><small>Укр-кою</small></span>
                      <textarea class="form-control" name="brand_description_ua" maxlength="1000" required="" rows="8" 
                        placeholder="Введіть короткий опис Бренду" aria-label="With textarea">
                      </textarea>
                    </div>
                      <div class="valid-feedback"> Тут все нібито чудово! </div>
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-6 mb-3">
                    ...
                    <div class="input-group">
                      <span class="input-group-text"><small>Рос-кою</small></span>
