<aside class="sidebar-left border-right bg-white shadow" id="leftSidebar" data-simplebar>
  ...
  <nav class="vertnav navbar navbar-light">
    ...
    <li class="nav-item dropdown">
        ...
        <li class="nav-item">
            <a class="nav-link pl-3" href="{{ route('brands.list-add') }}"><span class="ml-1 item-text">Бренди</span></a>
        </li>
        <li class="nav-item">
    ...
    <li class="nav-item dropdown">
        <a href="#widgets" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle nav-link">
        <i class="fe fe-box fe-16"></i>
        <span class="ml-3 item-text">Віджети</span>
        </a>
        <ul class="collapse list-unstyled pl-4 w-100" id="widgets">
        <li class="nav-item">
            <a class="nav-link pl-3" href="{{ route('brands.grid-detail') }}"><span class="ml-1 item-text">Віджет Бренди</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link pl-3" href="#"><span class="ml-1 item-text">Віджет Продукти</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link pl-3" href="#"><span class="ml-1 item-text">Віджет Категорії</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link pl-3" href="#"><span class="ml-1 item-text">Віджет Підкатегорії</span></a>
        </li>
        <li class="nav-item">
            <a class="nav-link pl-3" href="#"><span class="ml-1 item-text">Віджет  Під Підкатегорії</span></a>
        </li>               
        </ul>
    </li>
